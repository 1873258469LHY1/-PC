...
export default {
  ...
  methods: {
    ...
    async submit() {
      try {
        ...
        await this.$store.dispatch("getLoging", { phone, password });
        // await this.getLoging(phone, password)
  ...
  //   mounted(){
  //       this.getLoging(this.phone, this.password)
  //   }
};
</script>
